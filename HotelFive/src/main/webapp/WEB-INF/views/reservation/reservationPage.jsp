...
<style type="text/css">
	...
	#bill-table td:nth-of-type(2)>input {
		float : left;
	}
	#payBtn{
	border: none;
						...
						<div class="step1_user_info">
										<c:if test="${loginDTO eq null  }">
													<table id="bill-table" >
														<tr>
															<td >예약자명 : </td>
															<td ><input id="nmName" type="text" name="nmName"  style="background-color: #bff"/></td>
															<td></td>
															<td></td>
															<td></td>
														</tr>
														<tr>
															<td>연락처 : </td>
															<td>
																<input id="nmPhone" type="text" name="nmPhone" placeholder="하이픈(-) 포함"  style="background-color: #bff" /><br/>
