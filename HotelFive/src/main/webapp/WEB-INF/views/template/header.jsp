   ...
   * {
   ...
   body {
      ...
      .header-wrap {
         ...
         https://saeatechnote.tistory.com/entry/CSS-display-fixed-%EA%B0%80%EC%9A%B4%EB%8D%B0-%EC%A0%95%EB%A0%AC%ED%95%98%EA%B8%B0width: 1000px;
         margin: 0 auto;
         width : 1100px;
         top : 0;
         left : 0;
         ...
         <div id="login" class="login-box">
            <form method="POST">
                     <h1 >LOGIN</h1><br/>
                      ...
                      <a href="javascript:void(0);" onclick="cc()"><i class="fas fa-redo-alt"></i></a><br/>
                      <input id="loginButton" type="button" value="로그인"  onclick="fn_login(this.form)" />
                      <button id="kakaologin onclick="fn_login(this.form)" ></button>
