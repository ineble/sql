...
public class AdminListCommand implements Command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		int recordPerPage = 2; // 한페이지의 게시물 갯수
		int beginRecord = (page -1) * recordPerPage + 1; //1
		int endRecord = beginRecord + recordPerPage - 1; //2
		...
		// 페이지 ( << 1 2 3 >> )
		String pageView = PageMaker.getPageView("adminList", page, recordPerPage, totalRecord);
