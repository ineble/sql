...
<%
	...
	MemberBean m3 = new MemberBean("song","1234","송인재","song@test.com");
	memberList.add(m1);
	memberList.add(m2);
	memberList.add(m3);
...
<body>
	...
	<tr align="center">
	<td>${memberMap.memberList[2].id}</td>
	<td>${memberMap.memberList[2].pwd}</td>
	<td>${memberMap.memberList[2].name}</td>
	<td>${memberMap.memberList[2].email}</td>
	</tr>
